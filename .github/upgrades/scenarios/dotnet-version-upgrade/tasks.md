...
- ✅ 05-test-projects: Upgrade all test projects ([Content](tasks/05-test-projects/task.md), [Progress](tasks/05-test-projects/progress-details.md))
- ✅ 06-final-validation: Build solution and run all tests ([Content](tasks/06-final-validation/task.md), [Progress](tasks/06-final-validation/progress-details.md))
